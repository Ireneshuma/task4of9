public class four  {
    ...
    private static class GreaterThan1Exception extends Exception {
        public GreaterThan1Exception(String s) {
        }
    }

    private static class LessThan1Exception extends Throwable {
        public LessThan1Exception(String s) {
        }
    }
}
